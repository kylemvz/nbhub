...
c.JupyterHub.spawner_class = 'l41_nbhub.MarathonSpawner.MarathonSparkSpawner'
...
c.MarathonSpawner.docker_image_name = os.environ['JUPYTER_DOCKER_IMAGE'] 
...
c.MarathonSpawner.marathon_group = os.environ['MARATHON_GROUP']
